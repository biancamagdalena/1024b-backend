...
/*
1. Crie uma rota '\cliente_data_pedido' que retorne os clientes e a data que os mesmos fizeram 
...
/*4 Crie uma rota chamada '\quantidade_pedidos_clientes' que retorne um json no formato '[{nome:"tere",quantidade_pedidos:1000}]' que retorne 
